...
const AninationBloc = ({ containerInvers, props }) => {
    const { 
        tableImag, 
        shareBtnImg, 
        colouredCardBtnImg, 
        colouredCardImg, 
        linkedinBtnImg, 
        path3 } = props.pathImage
    return ( 
        <Fragment>
            <div className={`image-container ${ containerInvers ? containerInvers : ""}`}>
                <img alt="..." className="table-img" src={require("../../assets/img/presentation-page/" + tableImag)} />
                <img alt="..." className="share-btn-img" src={require("../../assets/img/presentation-page/" + shareBtnImg)} />
                <img alt="..." className="coloured-card-btn-img" src={require("../../assets/img/presentation-page/" + colouredCardBtnImg)} />
                <img alt="..." className="coloured-card-img" src={require("../../assets/img/presentation-page/" + colouredCardImg)} />
                <img alt="..." className="linkedin-btn-img" src={require("../../assets/img/presentation-page/" + linkedinBtnImg)} />
                <img alt="..." className="path path3"src={require("../../assets/img/" + path3)} />
...
AninationBloc.propTypes = {
  containerInvers: PropTypes.string,
  props: PropTypes.any
}
 
export default AninationBloc
